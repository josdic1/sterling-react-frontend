...
import { Home, Calendar, Users, LogOut, UserCheck, FileText, HelpCircle } from "lucide-react";
...
export function NavBar() {
  ...
  return (
    <nav className="sterling-nav">
      ...
      {/* 2. CENTER: LINKS */}
      <div className="nav-links" style={{ display: 'flex', gap: 'clamp(0.75rem, 3vw, 2rem)', justifyContent: 'center' }}>
        <Link 
          to="/" 
      ...
      <div className="nav-user" style={{ display: 'flex', alignItems: 'center', gap: '1rem', justifyContent: 'flex-end' }}>
        {/* HELP BUTTON - Always visible when logged in */}
        {loggedIn && (
          <button onClick={handleHelpClick} className="help-btn" title="Open Tutorial">
